...
MODEL_DDE_CM_DIA = function(t, y, parms) {
  ...
  DIA_INDUC1 <-0.2130/(1+exp(80 *(DIFF[((t-1)%%364)+1])))
  DIA_INDUC2 <- 0
  ...
  dDL5 = rep(0,nDL5)
  dDL5[1] = DIA_INDUC1 * sum(L5) - #Diapause in
